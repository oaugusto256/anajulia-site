  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        {/* Main columns */}
        <div className="footer-columns" style={{ display: "grid", gridTemplateColumns: "1fr", gap: 40, paddingBottom: "clamp(48px, 6vw, 64px)" }}>
          ...
          {footer.columns.map((col) => (
            <div key={col.title}>
              <div style={{
                ...
                color: "rgba(253,251,247,0.6)", marginBottom: 16,
              }}>
                {col.title}
              </div>
                  ...
                  return (
                    <li key={i}>
                      {href ? (
                        ...
                        <span style={{
                          fontFamily: "var(--font-inter)", fontSize: 14,
                          color: "rgba(253,251,247,0.8)", lineHeight: 1.4,
                        }}>
                          {link.label}
                        </span>
                      )}
...
function FooterIcon({ name }: { name: string }) {
  const style: React.CSSProperties = { width: 16, height: 16, flexShrink: 0, color: "rgba(253,251,247,0.7)" }
